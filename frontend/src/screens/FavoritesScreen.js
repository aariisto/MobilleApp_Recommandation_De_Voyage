...
const styles = StyleSheet.create({
  ...
  imageContainer: { height: CARD_WIDTH, borderRadius: 20, overflow: 'hidden', marginBottom: 10 },
  image: { width: '100%', height: '100%' },
  favoriteBtn: { position: 'absolute', top: 10, right: 10, backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: 15, width: 28, height: 28, justifyContent: 'center', alignItems: 'center' },
  ...
  imageContainer: { 
    ...
    overflow: 'hidden', 
    marginBottom: 10,
    backgroundColor: '#E1E1E1' // Fond gris clair pendant le chargement de l'image
  }
});
